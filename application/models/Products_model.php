...
class Products_model extends CI_Model{
    ...
    public function get_products_no_limit(){ // Get records without limit and offset
    ...
    public function get_products($limit, $offset){ // Get records with limit and offset
        //Equivalent to: SELECT * FROM tblproducts
        $query = $this->db->get('tblproducts');
        $result = $query->result();
        return $result;
    ...
    public function get_products_where($name){ // Get records with filter
